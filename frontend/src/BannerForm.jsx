...
import logo from "./assets/sujay-sierra-front-view-light.webp";
...
const BannerForm = () => {
  ...
  return (
    <div
      className="relative w-full h-[500px] flex items-center justify-center bg-cover bg-center px-4 sm:px-6 lg:px-12 py-6"
        ...
        <div className="bg-white p-5 sm:p-6 md:p-8 rounded-lg shadow-xl w-full max-w-lg z-10">
          ...
          <form className="space-y-4" onSubmit={handleFormSubmit} noValidate>
            ...
            <div className="flex items-start text-sm">
              ...
              />
              <span>
                I authorize Sujay Infra to Call, SMS, Email or WhatsApp me. I also accept T&C and Privacy Policy.
              </span>
            </div>
            {errors.agreeTerms && (
